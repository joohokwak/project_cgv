			...
			<table class="notice-table">
				<tr>
					...
					<td>
						...
						<input type="text" id="title" name="title" class="notice-input" style="width: 590px" value="${notice.n_title}">
					</td>
				</tr>
				<tr>
					...
					<td style="background: #fff;">
						<textarea rows="30" cols="100" id="content" name="content" style="width: 100%">${notice.n_content}</textarea>
					</td>
				</tr>
				<tr>
