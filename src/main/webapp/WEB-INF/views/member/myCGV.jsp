...
$(function(){
	...
	$(".cancle_btn").each(function(i, el) {
		$(".cancle_btn").eq(i).click(function(e) {
			...
			var rv_date = $(".rvDate").eq(i).text().split('[')[0];
			var rv_time = $(".rvTime").eq(i).text().split(' ')[0];
			var rvSeat = $(".rvSeat").text();
			...
			$.confirm({
				...
				$.ajax({
					...
					type : "post",
					data : 	{"rv_num" : rv_num , "s_num" : s_num , "rv_date" : rv_date, "rv_time" : rv_time, "rvSeat" : rvSeat},
					dataType : "text",
					success : function(data) {
						location.reload();
					}
					...
					<div class="contents_box">
						<div class="contents_box_detail">
							<dl>
								...
								<dd>
									<em>관람좌석</em>
									<strong class="rvSeat">${i.rv_seat }</strong>
