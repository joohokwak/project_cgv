...
insert into actor(a_num,a_kor_name,a_eng_name,a_birth,a_nation,a_img) value(0,'최희서','Choi Huiseo','1987-01-07','한국','choi_hui_seo.jpg');
insert into actor(a_num,a_kor_name,a_eng_name,a_birth,a_nation,a_site,a_img,a_biography) value(0,'마크 월버그','Mark Wahlberg','1971-06-05','미국','http://www.markwahlberg.com','Mark_Wahlberg.jpg','1971년 메사추세스 도체스터 출생으로 월버그는 힙합 아티스트로 경력을 시작했고 미키 마크라는 듀엣으로 래퍼로도 성공적인 활동을 했었다. 이후 캘빈 클라인의 광고 모델로 활동하며 90년대에 TV 시리즈의 조연배우로 출연하던 월버그는 1994년 으로 영화계에 데뷔한 후 레오나르도 디카프리오 주연의 에 함께 출연했으며 이후 96년도에 제임스 폴리 감독의 에서 처음으로 주연배우로 발탁되었다.이어 70년대 말부터 80년대 초에 성행한 미국 포르노 영화산업의 명암을 그린 폴 토마스 앤더슨 감독의 로 아카데미에 노미네이트 되어 스타성과 연기력을 인정받는다. 그가 처음으로 액션영화에 출연한 는 미 박스오피스 1위에 올랐으며, 주윤발과 함께 출연한 제임스 폴리 감독의 는 그의 연기범위를 폭넓게 했다. 99년작 에서는 아내아 딸은 둔 평범한 출신의 트로우 발로우 하사역을 맡았었고 2000년 여름을 강타한 볼프강 페터슨 감독의 에서 바비 새포드 역을 맡아 열연한 바 있다. 최근에 라는 작품을 선보인 월버그는 현재 에 출연 중이며, 국내배우인 박중훈이 출연한다고 화제를 모은 에 주인공으로 출연 중이다.');
...
insert into theater values(0, 'CGV구로', '서울특별시 구로구 구로5동 573번지 AK플라자', '서울특별시 구로구 구로중앙로 152 (구로동)', '1544-1122', 1900, 'noimage_final.jpg');
...
insert into theater values(0, 'CGV명동역 씨네라이브러리', '서울특별시 중구 충무로2가 65-9 하이해리엇', '서울특별시 중구 퇴계로 123 (명동)', '1544-1122', 694, 'LIB.JPG');
...
insert into theater values(0, 'CGV송파', '서울특별시 송파구 장지동 201-27 가든파이브', '서울특별시 송파구 충민로 66, 10층(문정동)', '1544-1122', 1481, 'CGVsongpa.jpg');
...
create view movie_info as
 ...
 create view connectionInfo as 
  select a.*, m.* from management mg left join actor a on mg.a_num = a.a_num
  left join movie m on mg.m_num = m.m_num;
